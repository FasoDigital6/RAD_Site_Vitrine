        ...
        return (
          <Link key={service.key} href={linkHref}>
            ...
            >
              ...
              {/* Détails */}
              {service.details && (
                <p className="mt-3 text-[10px] font-semibold uppercase tracking-wide text-rad-orange sm:mt-4 sm:text-xs">
                  {service.details}
                </p>
              )}

              {/* Flèche de navigation au hover */}
              <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-rad-orange opacity-0 transition-all group-hover:opacity-100 sm:mt-6 sm:text-sm">
